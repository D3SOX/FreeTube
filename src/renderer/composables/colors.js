...
export function useColorTranslations() {
  ...
  return computed(() => [
    ...
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Rosewater'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Flamingo'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Pink'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Mauve'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Red'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Maroon'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Peach'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Yellow'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Green'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Teal'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Sky'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Sapphire'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Blue'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Macchiato Lavender'),
